    ...
    async def start(self):
        ...
        if SEND_STARTUP_MESSAGE:
            await self.send_telegram(
                "✅ <b>Ahmed Delta Early Predictor v1.4 LAST CANDLE FILTER بدأ العمل</b>\n\n"
                "🎯 1H يُتوقع من 5M\n"
                "🎯 4H يُتوقع من 15M\n"
...
app = FastAPI(title="Ahmed Delta Early Predictor v1.4 LAST CANDLE FILTER", lifespan=lifespan)
...
async def health():
    return {
        ...
        "service": "Ahmed Delta Early Predictor v1.4 LAST CANDLE FILTER",
...
<title>Ahmed Delta Early Predictor v1.4 LAST CANDLE FILTER</title>
<style>
...
<body><div class="wrap">
<h1>Ahmed Delta Early Predictor v1.4 LAST CANDLE FILTER</h1>
