    ...
    async def start(self):
        ...
        if SEND_STARTUP_MESSAGE:
            await self.send_telegram(
                "✅ <b>Ahmed Delta Early Predictor v2.2 TARGET ATR + ADVANCED STATS بدأ العمل</b>\n\n"
                "🎯 1H يُتوقع من 5M\n"
                "🎯 4H يُتوقع من 15M\n"
    ...
    async def loop(self):
        while self.running:
            ...
            log.info(
                ...
                "liquidity=%s age=%s duplicate=%s] seconds=%.1f",
                self.scan_no,
                self.symbol_count,
...
app = FastAPI(title="Ahmed Delta Early Predictor v2.2 TARGET ATR + ADVANCED STATS", lifespan=lifespan)
...
async def health():
    return {
        ...
        "service": "Ahmed Delta Early Predictor v2.2 TARGET ATR + ADVANCED STATS",
...
<title>Ahmed Delta Early Predictor v2.2 TARGET ATR + ADVANCED STATS</title>
<style>
...
<body><div class="wrap">
<h1>Ahmed Delta Early Predictor v2.2 TARGET ATR + ADVANCED STATS</h1>
