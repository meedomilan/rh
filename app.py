    ...
    async def start(self):
        ...
        if SEND_STARTUP_MESSAGE:
            await self.send_telegram(
                "✅ <b>Ahmed Delta Early Predictor v2.3 TIMEOUT FIX + 24H VOLUME بدأ العمل</b>\n\n"
                "🎯 1H يُتوقع من 5M\n"
                "🎯 4H يُتوقع من 15M\n"
...
app = FastAPI(title="Ahmed Delta Early Predictor v2.3 TIMEOUT FIX + 24H VOLUME", lifespan=lifespan)
...
async def health():
    return {
        ...
        "service": "Ahmed Delta Early Predictor v2.3 TIMEOUT FIX + 24H VOLUME",
...
<title>Ahmed Delta Early Predictor v2.3 TIMEOUT FIX + 24H VOLUME</title>
<style>
...
<body><div class="wrap">
<h1>Ahmed Delta Early Predictor v2.3 TIMEOUT FIX + 24H VOLUME</h1>
