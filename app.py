    ...
    async def start(self):
        ...
        if SEND_STARTUP_MESSAGE:
            await self.send_telegram(
                "✅ <b>Ahmed Delta Early Predictor v2.8 ADAPTIVE ENTRY + DASHBOARD بدأ العمل</b>\n\n"
                "🎯 1H يُتوقع من 5M\n"
                "🎯 4H يُتوقع من 15M\n"
...
app = FastAPI(title="Ahmed Delta Early Predictor v2.8 ADAPTIVE ENTRY + DASHBOARD", lifespan=lifespan)
...
async def health():
    return {
        ...
        "service": "Ahmed Delta Early Predictor v2.8 ADAPTIVE ENTRY + DASHBOARD",
...
<div class="sub">v2.8 — دخول متكيف + تحليل اتجاه العملة + إحصائيات تفصيلية بلا حد</div>
